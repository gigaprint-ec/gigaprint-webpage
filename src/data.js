...
export const initialData = {
  ...
  products: [
    ...
    { id: 'corporeo', name: 'Corpóreos Publicitarios', category: 'Rótulos', type: 'm2', calcType: 'm2', pricingMode: 'area', price: 35.0, unit: 'm²', image: media.letrero, description: 'Letras y logos en relieve cortados con precisión CNC en acrílico, PVC o MDF.', featured: true, specs: ['Acrílico, PVC o MDF', 'Corte CNC de alta precisión', 'Acabado personalizado'] },
