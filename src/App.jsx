...
function AdminRoutes() { const { pathname } = useLocation(); if (pathname === '/admin/login') return <AdminLogin />; const pages = { '/admin': <AdminDashboard />, '/admin/pos': <POSPage />, '/admin/crm': <POSPage />, '/admin/pos/dashboard': <POSAdminDashboard />, '/admin/pos/asesoras': <POSAdvisorsManagement />, '/admin/pos/asesores': <POSAdvisorsManagement />, '/admin/asesores': <POSAdvisorsManagement />, '/admin/equipo': <POSAdvisorsManagement />, '/admin/pos/display': <POSCustomerDisplayPage />, '/admin/pos/cliente': <POSCustomerDisplayPage />, '/admin/pos/productos': <POSPage />, '/admin/editor': <EditorPage />, '/admin/contenido': <AdminContent />, '/admin/productos': <SmartAdminProducts />, '/admin/temas': <AdminThemes />, '/admin/promociones': <AdminPromos />, '/admin/solicitudes': <AdminInquiries /> }; return <AdminGuard>{pages[pathname] || <Navigate to="/admin" replace />}</AdminGuard>; }
