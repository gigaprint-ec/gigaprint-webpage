...
export function MediaUploader({ value = [], onChange, accept = 'image/*,.pdf,.doc,.docx,.xls,.xlsx,.zip', multiple = true, label = 'Medios y archivos', helper = 'Arrastra imágenes, documentos o archivos de marca' }) {
