...
function AdminRoutes() { const { pathname } = useLocation(); if (pathname === '/admin/login') return <AdminLogin />; const pages = { '/admin': <AdminDashboard />, '/admin/pos': <POSPage />, '/admin/pos/dashboard': <POSAdminDashboard />, '/admin/pos/asesoras': <POSAdvisorsManagement />, '/admin/editor': <EditorPage />, '/admin/contenido': <AdminContent />, '/admin/productos': <SmartAdminProducts />, '/admin/temas': <AdminThemes />, '/admin/promociones': <AdminPromos />, '/admin/solicitudes': <AdminInquiries /> }; return <AdminGuard>{pages[pathname] || <Navigate to="/admin" replace />}</AdminGuard>; }

function PublicRoutes() { return <Routes><Route path="/" element={<HomePage />} /><Route path="/gigaprint" element={<AboutPage />} /><Route path="/promociones" element={<PromotionsPage />} /><Route path="/tienda" element={<StorePage />} /><Route path="/tienda/:id" element={<SmartProductDetailPage />} /><Route path="/cotizador" element={<SmartQuotePage />} /><Route path="/contacto" element={<ContactPage />} /><Route path="/carrito" element={<CartPage />} /><Route path="/pos" element={<POSPage />} /><Route path="/pos/*" element={<POSPage />} /><Route path="*" element={<Navigate to="/" replace />} /></Routes>; }
